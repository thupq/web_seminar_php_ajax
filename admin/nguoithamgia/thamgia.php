...
<body>
	...
	<div class="container">
        <div id="header">
            <h2 style="text-align: center;">Danh sách người tham gia đã duyệt</h2>
        </div>
        <div>
			<a href="../nguoithamgia/"><button type="button" class="btn btn-success" >Danh sách chưa duyệt</button></a>
    ...
    <script>
        $(document).ready(function(){
            $('.timkiem').keyup(function(){
                var txt = $('.timkiem').val();
                $.post('ajaxtimkiem2.php',{data: txt}, function(data){
                    $('.danhsach').html(data);
                })
            });
            $(".phantrang").on("click","li a", function(event){
                ...
                var page = $(this).text();
                $.post('ajaxphantrang2.php',{page: page}, function(data){
                    $('.danhsach').html(data);
                })
            });
        })
